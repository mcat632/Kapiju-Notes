...
- Evidence domains: mobile, computer, drone, SIM/eSIM, debit/credit card, crypto, automotive, OBD-II, ECU, and CAR-CAN investigation/repair workflows with separate raw and processed evidence areas.
...
- Modern GUI: native desktop interface with dashboards, case cards, timelines, OSINT panels, evidence widgets, and fast report export.
