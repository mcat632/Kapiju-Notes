...
CASE_DIRECTORIES = [
    ...
    "Evidence/Financial/Cards/Debit",
    "Evidence/Financial/Cards/Credit",
    "Evidence/Mobile",
    "Evidence/Mobile/SIM",
    "Evidence/Mobile/eSIM",
    "Evidence/Computer",
    "Evidence/Drone",
    "Evidence/Automotive/CAR-CAN",
    "Evidence/Automotive/OBD-II",
    "Evidence/Automotive/ECU",
    "Evidence/CAR-CAN",
    "Artifacts",
    "Reports",
    "Notes",
...
def desktop(args: argparse.Namespace) -> int:
    from .desktop import run_desktop
...
def web(args: argparse.Namespace) -> int:
    ...
    run_gui(args.host, args.port, args.open_browser)
    return 0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    gui_parser = sub.add_parser("gui", help="launch the native IOC-CMS desktop GUI")
    gui_parser.set_defaults(func=gui)

    desktop_parser = sub.add_parser("desktop", help="launch the native IOC-CMS desktop GUI")
    desktop_parser.set_defaults(func=desktop)

    web_parser = sub.add_parser("web", help="launch the optional local IOC-CMS web preview")
